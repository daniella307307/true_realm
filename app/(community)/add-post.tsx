    ...
    <View className="flex-1 bg-background p-4">
      ...
      <View className="mb-4">
        ...
        <TextInput
          ...
          {...register("title")}
        />
        {errors.title && <Text className="text-red-500 text-xs/1 mt-2">{errors.title.message}</Text>}
      </View>
      ...
      <View className="mb-4">
        ...
        />
        {errors.description && (
          <Text className="text-red-500 text-xs/1 mt-2">{errors.description.message}</Text>
        )}
      </View>
